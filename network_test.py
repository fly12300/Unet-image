...
def unet_test(img_w, img_h, n_label, data_format='channels_first', learningRate=1e-5, decayRate=1e-7):
    if data_format == 'channels_first':
...
########################################################################################################
#Attention U-Net
def att_unet_test(img_w, img_h, n_label, data_format='channels_first', learningRate=1e-5, decayRate=1e-7):
    if data_format == 'channels_first':
        inputs = Input((1, img_w, img_h))
    else:
        inputs = Input((img_w, img_h, 1))
...
def r2_unet_test(img_w, img_h, n_label, data_format='channels_first', learningRate=1e-5, decayRate=1e-7):
    if data_format == 'channels_first':
        inputs = Input((1, img_w, img_h))
    else:
        inputs = Input((img_w, img_h, 1))
...
#Attention R2U-Net
def att_r2_unet_test(img_w, img_h, n_label, data_format='channels_first', learningRate=1e-5, decayRate=1e-7):
    if data_format == 'channels_first':
        inputs = Input((1, img_w, img_h))
    else:
        inputs = Input((img_w, img_h, 1))
